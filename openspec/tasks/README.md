...
| [task-003-finder-plugin](./phase-1/task-003-finder-plugin.md) | 文件搜索插件 | 12h | 002 | 待开发 |
| [task-004-wiki-plugin](./phase-1/task-004-wiki-plugin.md) | 知识库插件 | 16h | 001 | 待开发 |
